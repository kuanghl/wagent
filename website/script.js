...
function skillPath(skill) {
  ...
  return `https://github.com/kuanghl/wagent/tree/master/low-level-dev-skills/skills/${catDirMap[skill.category]}/${skill.name}/SKILL.md`;
}
...
const BASE_CMD = 'npx skills add kuanghl/wagent/low-level-dev-skills --skill';
...
function setupCopy() {
  ...
  const cmd = 'npx skills add kuanghl/wagent/low-level-dev-skills --all';

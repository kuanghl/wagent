...
description: Vue 按钮组件技能。提供 6 type × 3 variant × 3 size 按钮矩阵，纯 CSS 实现，零第三方组件库，按钮组/操作栏必须嵌入 base-card 容器。触发词："做一个按钮"、"主色按钮"、"实心按钮"、"描边按钮"、"幽灵按钮"、"文字按钮"、"危险按钮"、"禁用按钮"、"加载中按钮"、"块级按钮"、"底部固定按钮"、"提交按钮"、"base-button"。
---
